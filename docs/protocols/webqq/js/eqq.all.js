        ...
        var d = b.dom,
            ...
            h = function (d, h) {
                ...
                if (h) for (var u = 0; u < d.content.length; u++) {
                    ...
                    q += '<a href="#" id="cancal_uploadOffFile_' + d.attach.ts + '">[\u53d6\u6d88]</a>', q += "</span></div>") : j[0] === "transtimeout" ? q += '<div class="msgFileBox">\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u8d85\u65f6,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : j[0] === "refusedbyclient" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : j[0] === "transok" ? q += '<div class="msgFileBox">\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u4f20\u8f93\u6210\u529f.</div>' : j[0] === "transerror" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u6216\u4f20\u8f93\u9519\u8bef,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : b.isArray(j) || (q += f(c.encodeHtmlSimple(f(j, 1)), 2))
                } else {
                    var u = d.sender_uin || d.from_uin,
                        z = d.from_uin || 0,
                        I = [],
                        G, A, y;
                    for (y = d.content[0][0] !== "font" ? 0 : 1; y < d.content.length; y++) if (j = d.content[y], b.isString(j) && j.substr(0, 4) === "\u3000  \u3000") d.content[0] = [], j = "", b.platform.iPad && (j = "\u4f46\u60a8\u4f7f\u7528\u7684\u8bbe\u5907\u4e0d\u652f\u6301\u89c6\u9891\u901a\u8bdd\u529f\u80fd\u3002"), q += '<div class="msgFileBox">\u5bf9\u65b9\u5411\u60a8\u53d1\u8d77\u89c6\u9891\u9080\u8bf7\u3002' + j + "</div>";
                        ...
                        q += j
                    } else q += g(d.msg_id, j[1], u), alloy.util.report2m(133157), alloy.util.report2m(133158);
                    ...
                    q += '<span class="icon_' + n(j[1]) + '">&nbsp;</span>' + c.encodeHtmlSimple(j[1]), q += '<span class="fileAct">', C[v].isread ? q += "&nbsp;[\u540c\u610f][\u62d2\u7edd]" : (q += '&nbsp;<a id="agree_' + v + '" href="#">[\u540c\u610f]</a>', q += '&nbsp;<a id="refuse_' + v + '" href="#">[\u62d2\u7edd]</a>'), q += "</span>", q += "</div>") : j[0] === "rffile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : j[0] === "rtfile" ? q += '<div class="msgFileBox">\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u8d85\u65f6,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : j[0] === "wrfile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u5df2\u540c\u610f\u63a5\u6536"' + c.encodeHtmlSimple(j[1]) + '",\u5f00\u59cb\u4f20\u8f93\u6587\u4ef6.</div>' : j[0] === "wrffile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u62d2\u7edd\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>' : j[0] === "cvideo" ? (q += c.encodeHtmlSimple(j[1]), q += '&nbsp;<a id="video_' + d.attach.from_uin + "_" + d.attach.msg_id + '" fromuin="' + d.attach.from_uin + '" href="###">\u53d1\u8d77\u89c6\u9891</a>') : (j[0] === "video" ? j = c.encodeHtmlSimple(j[1]) : j[0] === "offfile" ? (j = d, v = j.attach.from_uin + "_" + j.attach.msg_id, C = b.date.format(new Date(j.attach.expire_time * 1E3), "YYYY-MM-DD"), r = '<div class="msgFileBox">\u5bf9\u65b9\u7ed9\u60a8\u53d1\u9001\u79bb\u7ebf\u6587\u4ef6:<br />', r += '<span class="icon_' + n(j.attach.name) + '">&nbsp;</span>' + c.encodeHtmlSimple(j.attach.name) + "(" + C + "\u5230\u671f)", r += '<span class="fileAct">',
                ...
                return function (a, b) {
                    try {
                        if (arguments.length == 2) return !b || arguments.callee(a);
                            ...
                            else a = a.o, d = [c, a.status, a.responseText.replace(/[\r\t\n\s]/g, "") + ":", decodeURIComponent(a.data), a.uri].join("$");
            ...
            var d = {
                ...
                onSuccess: function (a) {
                    ...
                    try {
                        ...
                        a.responseText += ":BJF:", d = !0, b.out("JSON\u683c\u5f0f\u51fa\u9519:" + f)
                    } finally {
...
(function () {
    WebqCore.register("EQQ.Model.BuddyList", function (b) {
        var d = this,
            ...
            E = new b.Class({
                ...
                setSignature: function (i) {
                    if (i != void 0) this.signature = i, this.htmlSignature = b.string.encodeHtmlSimple(i), this.titleSignature = b.string.encodeHtmlAttributeSimple(i);
        ...
        var M = function (a) {
            ...
            if (b.isArray(e)) k = d.getGroupByCode(e), f = a.result ? a.result.memo || " " : " ", k.setAnnouncement(f);
            else for (var c in e) {
                var k = e[c],
        ...
        this.getDiscuInfo = function (a) {
            ...
            !b.isUndefined(e) && e.isLoadInfo ? c.notifyObservers(this, "DiscuInfoChange", e) : J(a)
        };
...
(function () {
    WebqCore.register("EQQ.Model.ChatMsg", function (b) {
        ...
        this.preloadGroupMessageImages = function (a, c) {
            ...
            }, l = 0, p = d.length; l < p; l++) if (d[l][0] === "cface") n = d[l][1], h = n.server.toString().split(":"), h = EQQ.CONST.CHAT_PIC_SERVER + "cgi-bin/get_group_pic?type=" + c + "&gid=" + m + "&uin=" + f + "&rip=" + h[0] + "&rport=" + h[1] + "&fid=" + n.file_id + "&pic=" + n.name + "&vfwebqq=" + alloy.portal.getVfWebQQ() + "&t=" + j, g = new Image, g.src = h, g.onload = i, g.onerror = s
        };
        ...
        this.receiveTransferMsg = function (a) {
            ...
            if (b.file_name != "") {
                var c = "",
                    f = "";
                if (b.file_status == 51) c = [
                    ["transtimeout", b.file_name, a.lc_id]
                ], f = {
                    type: "transtimeout",
                    name: b.file_name,
                    isread: !0
                };
                else if (b.file_status == 50) c = [
                    ["transerror", b.file_name, a.lc_id]
                ], f = {
                    type: "transerror",
                    name: b.file_name,
                    isread: !0
                };
                else if (b.file_status == 53) c = [
                    ["refusedbyclient", b.file_name, a.lc_id]
                ], f = {
                    type: "refusedbyclient",
                    name: b.file_name,
                    isread: !0
                };
                else if (b.file_status == 0) c = [
                    ["transok", b.file_name, a.lc_id]
                ], f = {
                    type: "transok",
                    name: b.file_name,
                    isread: !0
                }, alloy.util.report2m(133176), a.operation == 1 ? alloy.util.report2m(133152) : a.operation == 2 && alloy.util.report2m(133165);
                else return b.file_status != 10 && alloy.util.report2m(133177), !1;
    ...
    d = function (b) {
        ...
        Q = function (a) {
            ...
            Ia = function (c) {
                ...
                c.preventDefault();
                if (!H) H = !0, k = h.EQQ_MySignature.value, g.on(h.EQQ_MySignature, "blur", na), a.addClass(h.EQQ_MySignature_wraper, "EQQ_MySignature_edit"), h.EQQ_MySignature.focus(), h.EQQ_MySignature.select(), pgvSendClick({
        ...
        var ga = this.loadBuddyListAvatar = function () {
            ...
            if (aa()) {
                ...
                b = a.getXY(b)[1];
                for (f = 0; f < u.length;) g = u[f], e = g.el, l = g.uin, g = g.classId, i = a.getXY(e)[1] - b, h.getClassExpandFlag(g) && e && i > 0 && i < d ? (e.hasSign || EQQ.Model.BuddyList.getUserSignature(l), u.splice(f, 1)) : f++
            }
        }, fa = function () {
            la()
        }, la = function () {
            ...
            for (a = []; c = I.shift();) b = c.el, c = c.gcode, b.hasSign || a.push(c);
            a.length && EQQ.Model.BuddyList.getMultiGroupAnnounce(a)
        };
        ...
        this.updateClientType = function (b) {
            var c = EQQ.hash.clientType[b.clientType],
                ...
                f = a.id("EQQ_BuddyList_ClientType_" + b.uin) || {}, e = a.id("EQQ_BuddyList_ClientType_Title_" + b.uin) || {};
        ...
        this.updateRecentState = function (b) {
            ...
            if (c) {
                ...
                var c = EQQ.hash.clientType[b.clientType],
                    d = EQQ.hash.clientTypeText[b.clientType] || "PC",
                    f = a.id("EQQ_RecentList_ClientType_" + b.uin) || {}, b = a.id("EQQ_RecentList_ClientType_Title_" + b.uin) || {};
                f.className = "EQQ_BuddyList_ClientType_" + c;
                b.title = d
            }
        };
