...
Jx().$package(function (d) {
    ...
    a[a.name] = !0;
    (f = i.match(/windows ([\d.]+)/)) ? a.set("win", g(f[1])) : (f = i.match(/windows nt ([\d.]+)/)) ? a.set("win", g(f[1])) : (f = i.match(/linux ([\d.]+)/)) ? a.set("linux", g(f[1])) : (f = i.match(/mac ([\d.]+)/)) ? a.set("mac", g(f[1])) : (f = i.match(/ipod ([\d.]+)/)) ? a.set("iPod", g(f[1])) : (f = i.match(/ipad[\D]*os ([\d_]+)/)) ? a.set("iPad", g(f[1])) : (f = i.match(/iphone ([\d.]+)/)) ? a.set("iPhone", g(f[1])) : (f = i.match(/android ([\d.]+)/)) && a.set("android",
    g(f[1]));
    e = {
        features: {
    ...
    d.browserOptions.htmlClass && function () {
...
Jx().$package(function (d) {
    ...
    b.getScrollWidth = function (c) {
        return (c ? c.scrollWidth : Math.max(document.documentElement.scrollWidth,
...
Jx().$package(function (d) {
    ...
    i = Array.prototype.indexOf ? function () {
    ...
    j = Array.prototype.lastIndexOf ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
    ...
    e = Array.prototype.filter ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
    ...
    h = Array.prototype.some ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
    ...
    g = Array.prototype.map ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
        return Array.prototype.map.apply(arguments[0],
        c)
    } : function (c, a, b) {
        var d = c.length;
        if (typeof a != "function") throw new TypeError;
    ...
    f = Array.prototype.every ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
    ...
    n = Array.prototype.reduce ? function () {
    ...
    k = Array.prototype.reduceRight ? function () {
        var c = Array.prototype.slice.call(arguments, 1);
        return Array.prototype.reduceRight.apply(arguments[0],
        c)
    } : function (c, a) {
        var b = c.length >>> 0;
        if (typeof a != "function") throw new TypeError;
    ...
    b.bubbleSort = function (c, a) {
        for (var a = a || function (c, a) {
                return c - a
            }, b = c.length, d, e, f = 0; f < b - 1; f++) {
            e = !1;
            for (var g = b - 1; g > f; g--) a(c[g], c[g - 1]) < 0 && (e = !0, d = c[g - 1], c[g - 1] = c[g],
            c[g] = d);
            if (!e) break
        }
        return c
...
Jx().$package(function (d) {
    ...
    a = function (e, f, h) {
        ...
        var t = h.onSuccess || function () {}, u = h.onError || function () {}, l = h.onComplete || function () {}, y, z = h.onTimeout || function () {}, B = h.timeout,
        ...
        e === "script" ? k = h.node || function (a, b, d, e) {
            a = i.node("script", {
                id: "jet_load_" + c,
        ...
        if (d.browser.engine.trident && parseInt(d.browser.ie) < 9) k.onreadystatechange = function () {
            ...
            var a;
            if (!v) x = !0, window.clearTimeout(r), r = null, a = {}, a.id = c, a.uri = f, a.arguments = arguments, t(a), l(a),
            e === "script" && y(c)
        });
...
Jx().$package(function (d) {
    ...
    var e = new d.Class({
        ...
        update: function () {
            ...
            this.onLoop(), a.loop <= 0 || --this.loop ? this.time = c : (this.stopTimer(), this.onEnd())
        },
        stopTimer: function () {
        ...
        p = function (c, a) {
            ...
            update: function () {
                var a = d.now(),
                    b = this.option;
                a < this.time + this.option.duration ? this.set(this.compute(this.from,
                this.to, b.transition((a - this.time) / b.duration))) : (this.set(this.compute(this.from, this.to, 1)), this.end())
            },
            set: function (a) {
                var b = this.option;
...
Jx().$package(function (d) {
    ...
    d.ui.ScrollBar = new d.Class({
        ...
        init: function (j, a) {
            ...
            this.onscroll = a.onscroll || function () {};
            ...
            var h = {
                onMouseDown: function (a) {
                    ...
                    e.isScrolling = !0;
                    e.option.barActiveClass && b.addClass(e.bar,
                    e.option.barActiveClass)
                },
                ...
                onBarMouseUp: function () {
                    d.platform.iPad ? (i.off(document, "touchmove", h.onMouseMove), i.off(document, "touchend", h.onBarMouseUp)) : (i.off(document, "mousemove", h.onMouseMove),
                    i.off(document, "mouseup", h.onMouseUp));
                    e.isScrolling = !1;
...
Jet().$package(function (d) {
    var b = d.dom,
        ...
        j = d.ui.Bubble = d.Class({
            init: function (a) {
                var a = a || {}, a = this.option = d.extend({
...
Jx().$package(function (d) {
    ...
    d.extend(d.console, {
        ...
        show: function () {
            ...
            this.render();
            window.setTimeout(d.bind(this.focusCommandLine,
            this), 0)
        },
        hide: function (a) {
            a && a.preventDefault();
        ...
        onInputKeyup: function (a) {
            ...
            case 40:
                if (this._cmd_history.length == 0) break;
                a = "";
                this._cmd_last_index < this._cmd_history.length - 1 ? (this._cmd_last_index++,
                a = this._cmd_history[this._cmd_last_index]) : this._cmd_last_index = this._cmd_history.length;
                d.console._inputEl.value = a
            }
        },
    ...
    var b = function () {
        ...
        function n(a, b, c, d) {
            ...
            if (e) {
                ...
                if (s.ie && s.win && e.readyState != 4) d = q.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), e.parentNode.insertBefore(d, e), e.style.display = "none",
                function () {
        ...
        (function () {
            s.w3 && ((typeof q.readyState != l && q.readyState == "complete" || typeof q.readyState == l && (q.getElementsByTagName("body")[0] || q.body)) && d(), E || (typeof q.addEventListener != l && q.addEventListener("DOMContentLoaded", d, !1), s.ie && s.win && (q.attachEvent("onreadystatechange", function () {
                q.readyState == "complete" && (q.detachEvent("onreadystatechange",
                arguments.callee), d())
            }), w == top && function () {
                if (!E) {
                    try {
        ...
        d.GetSwfVer = function () {
            ...
            if (navigator.plugins != null && navigator.plugins.length > 0) {
                ...
                if (!g) try {
                    ...
                    g = "WIN 6,0,21,0", h.AllowScriptAccess = "always", g = h.GetVariable("$version")
                } catch (k) {}
                if (!g) try {
...
Jx().$package(function (d) {
    ...
    e = {
        ...
        load: function (a) {
            ...
            }, !1)), b.id("sound_object_container").appendChild(a),
            this._obj = a;
    ...
    a = {
        init: function (a, c, d) {
            ...
            this._url = a;
            this._id = g.length;
            if (c) this._fid = b.id("JxSwfSound_Flash").loadSound(this._url, - 1, !0),
            this._correctVolume();
            g.push(this)
        },
        load: function (a) {
