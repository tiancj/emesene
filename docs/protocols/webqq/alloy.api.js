...
Jx().$package(function (c) {
    ...
    n = function (a) {
        return a && a.constructor === Object || String(a) === "[object Object]"
    };
    g = function (a) {
...
Jx().$package(function (c) {
    ...
    m[m.name] = !0;
    (e = q.match(/windows ([\d.]+)/)) ? m.set("win", g(e[1])) : (e = q.match(/windows nt ([\d.]+)/)) ? m.set("win", g(e[1])) : (e = q.match(/linux ([\d.]+)/)) ? m.set("linux", g(e[1])) : (e = q.match(/mac ([\d.]+)/)) ? m.set("mac", g(e[1])) : (e = q.match(/ipod ([\d.]+)/)) ? m.set("iPod", g(e[1])) : (e = q.match(/ipad[\D]*os ([\d_]+)/)) ? m.set("iPad", g(e[1])) : (e = q.match(/iphone ([\d.]+)/)) ? m.set("iPhone", g(e[1])) : (e = q.match(/android ([\d.]+)/)) && m.set("android",
    g(e[1]));
    j = {
        features: {
    ...
    c.browserOptions.htmlClass && function () {
...
Jx().$package(function (c) {
    ...
    b.getScrollWidth = function (a) {
        return (a ? a.scrollWidth : Math.max(document.documentElement.scrollWidth,
...
Jx().$package(function (c) {
    ...
    b.stripScripts = function (a, d) {
        var b = "",
            c = a.replace(/<script[^>]*>([\s\S]*?)<\/script>/gi,
...
Jx().$package(function (c) {
    ...
    m = function (g, e, k) {
        ...
        var n = k.onSuccess || function () {}, v = k.onError || function () {}, r = k.onComplete || function () {}, s, t = k.onTimeout || function () {}, w = k.timeout,
            y = k.charset ? k.charset : "utf-8",
            z = k.win || window,
            A, e = e || "";
        l !== null && (e = e + "?" + l);
        a = m.Id++;
        ...
        g === "script" ? h = k.node || function (d, b, c, f) {
            d = q.node("script", {
                id: "jet_load_" + a,
        ...
        if (c.browser.engine.trident && parseInt(c.browser.ie) < 9) h.onreadystatechange = function () {
            ...
            var d;
            if (!i) j = !0, window.clearTimeout(f), f = null, d = {}, d.id = a, d.uri = e, d.arguments = arguments, n(d), r(d),
            g === "script" && s(a)
        });
    ...
    var b = function () {
        ...
        function m(b, c, a) {
            ...
            for (var f = [], h = -1, j = (d.match(g) || k)[1], p = !j && (d.match(n) || k)[1], d = !j && (d.match(e) || k)[1], q = -1, r, s, t, d = d && d.toLowerCase(); r = c[++q];) {
                s = r.parentNode;
                do if (t = (t = (t = !d || d === "*" || d === s.nodeName.toLowerCase()) && (!j || s.id === j)) && (!p || RegExp("(^|\\s)" + p + "(\\s|$)").test(s.className)), a || t) break;
...
Jx().$package(function (c) {
    ...
    q = Array.prototype.indexOf ? function () {
    ...
    m = Array.prototype.forEach ? function () {
        var a = Array.prototype.slice.call(arguments, 1);
    ...
    n = Array.prototype.some ? function () {
        var a = Array.prototype.slice.call(arguments, 1);
    ...
    e = Array.prototype.every ? function () {
        var a = Array.prototype.slice.call(arguments, 1);
    ...
    k = Array.prototype.reduce ? function () {
    ...
    h = Array.prototype.reduceRight ? function () {
        var a = Array.prototype.slice.call(arguments, 1);
    ...
    b.bubbleSort = function (a, b) {
        for (var b = b || function (a, b) {
                return a - b
            }, c = a.length, h, e, l = 0; l < c - 1; l++) {
            e = !1;
            for (var g = c - 1; g > l; g--) b(a[g], a[g - 1]) < 0 && (e = !0, h = a[g - 1], a[g - 1] = a[g],
            a[g] = h);
            if (!e) break
        }
        return a
...
Jx().$package(function (c) {
    ...
    c.extend(c.console, {
        ...
        show: function () {
            ...
            this.render();
            window.setTimeout(c.bind(this.focusCommandLine,
            this), 0)
        },
        hide: function (b) {
            b && b.preventDefault();
        ...
        onInputKeyup: function (b) {
            ...
            case 40:
                ...
                b = this._cmd_history[this._cmd_last_index]) : this._cmd_last_index = this._cmd_history.length;
                c.console._inputEl.value = b
            }
        },
...
Jx().$package("alloy", function (c) {
    var b = this,
        ...
        f = {
            ...
            }), o.documentElement.doScroll && l == l.top && function () {
                if (!g) {
                    try {
    ...
    this.api = function (a, b) {
        ...
        if (d) {
            ...
            if (e) {
                ...
                c.isUndefined(e.makeParam) ? c.extend(g.param.param, b.param) : (e = e.makeParam(b.param), c.extend(g.param.param,
                c.isObject(e) ? e : {
                    r: e
                }));
