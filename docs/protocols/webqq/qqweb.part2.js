        ...
        g, b = function () {
            ...
            setEnableDrag: function () {
                if (this.option.dragable) {
                    ...
                    } else this.option.dragProxy ? (this._dragProxy = b(), d.on(this.container, "mousedown", this.observer.onMousedown),
                    this._dragController = new f.ui.Drag(this.container, this._dragProxy.proxyEl, {
                        isLimited: !0,
                    ...
                    }), d.addObserver(this._dragController, "end", this.observer.onDragProxyEnd)) : (this._dragController = new f.ui.Drag(this.container,
                    this.container, {
                        isLimited: !0,
                        clientEl: this.option.dragLimitEl || this.option.appendTo,
            ...
            setLimite: function (a) {
                a = a || {};
                if (this.isLimited) this._leftMargin = a.leftMargin, this._topMargin = a.topMargin, this._rightMargin = a.rightMargin,
            ...
            showWinBorder: function () {
                if (this.isBorderHide) this.isBorderHide = !1, e.show(this._window_bg),
                e.show(this._titleBar), this.setWidth(this.getBodyWidth()), this.setHeight(this.getBodyHeight())
            },
        ...
        b = new f.Class({
            init: function (a) {
                ...
                this._private = {
                    ...
                    startTimeoutClearNodes: function (a) {
                        ...
                        this._clearNodesTimer = window.setTimeout(this.timeoutClearNodes,
                        a || 0)
                    },
                ...
                if (g.adobeAir) e.on(h, "keyup", f.bind(b.observer.onAdobeAirKeyup,
                m));
            ...
            setState: function (a) {
                ...
                var b = this._textArea,
                    c = this._divArea;
                a ? (d.show(c),
                d.hide(b), b.readonly = !0, c.setAttribute("contentEditable", !0)) : (d.hide(c), d.show(b), b.readonly = !1, c.setAttribute("contentEditable", !1))
            },
            isEditable: function () {
            ...
            restoreRange: function () {
                if (this._lastRange) {
                    ...
                    if (a.addRange) a.removeAllRanges(), a.addRange(this._lastRange);
                    else if (a = b.getRange()) a.setEndPoint("EndToStart", this._lastRange), a.collapse(!1), a.setEndPoint("EndToEnd", this._lastRange), a.select()
                }
            },
            insertHtml: function (a) {
                if (a !== "") {
                    ...
                    } else this.isEmpty() ? this._divArea.innerHTML = a : this._divArea.innerHTML += a, c = b.getRange(), a = this._divArea.lastChild, c.selectNode ? (c.setEndAfter(a), c.setStartAfter(a),
                    f = b.getSelection(), f.removeAllRanges(), f.addRange(c)) : c.moveToElementText && (c.moveToElementText(a), c.collapse(!1), c.select());
    ...
    var e = f.dom,
        ...
        g = new f.Class({
            ...
            initButtons: function () {
                ...
                }), this.option.hasPinUpButton && (this._pinUpButton.show(),
                this._pinDownButton.hide()), this.option.hasPinDownButton && (this._pinUpButton.hide(), this._pinDownButton.show())
            },
            createEvent: function () {
                this.setEnableDrag();
    ...
    this.Icon = new f.Class({
        ...
        parseOption: function (a) {
            return this.option = a = {
                ...
                cxBeforeShow: a.cxBeforeShow || function () {},
                lock: a.lock || !1,
                attrs: a.attrs,
        ...
        _createDom: function () {
            ...
            var j = this._domId = "alloy_icon_" + a.id + "_" + b++,
                k = a.attrs || {}, h = this._formatTitle(a.title),
                k = f.extend(k, {
                    id: j,
                    uid: a.id,
    ...
    var e = f.dom,
        ...
        h = {
            ...
            init: function (a, c) {
                ...
                d.addObserver(this, "contextmenu", f.bind(h.onContactIconContextMenu,
                this))
            },
...
Jx().$package("alloy.clipBoard", function (f) {
    ...
    d.addObserver(e, "BEFORE_CLIP_DATA_CHANGED",
    f.onBeforeClipDataChanged);
    ...
    var e = this,
        ...
        n = function (a, b) {
            if (!b || b == -1) {
                ...
                id: b
            }), f.isNumber(d) && d >= 0 && d < 5 && alloy.desktopManager.setCurrentDesktop(d),
            qqweb.portal.runApp(b));
            c.value = "\u641c\u7d22\u7f51\u9875\u548c\u5e94\u7528...";
            q.close()
        }, l = function (a) {
            var b = c.value;
...
Jet().$package("alloy.businessClass", function (f) {
    ...
    this.ShareFriends = new f.Class({
        ...
        renderShareList: function () {
            ...
            this.share_list.length == 0 ? (this._share_list_container.className = "sharef_list_container sharef_tip", this._share_title.innerHTML = '\u53ef\u4ee5\u9080\u8bf7<span class="sharef_limit">10</span>\u4e2a\u597d\u53cb',
            this._share_send.className = "sharef_submit sharef_disabled") : (this._share_list_container.className = "sharef_list_container", this._share_title.innerHTML = '\u8fd8\u53ef\u4ee5\u9080\u8bf7<span class="sharef_limit">' + (10 - this.share_list.length) + "</span>\u4e2a\u597d\u53cb", this._share_send.className = "sharef_submit")
        },
        getEQQFriendList: function () {
            for (var a = EQQ.Model.BuddyList.getBuddyList(), b = EQQ.Model.BuddyList.getClassList(), c = [], d = 0; d < b.length; ++d) {
                var f = b[d];
                c[f.index] = {
                    title: f.htmlName.length > 15 ? f.htmlName.substr(0,
                    15) + "\u2026" : f.htmlName,
    ...
    this.App = new f.Class({
        ...
        run: function (c) {
            ...
            if (window.webTop && this.option.id == 12) alloy.layout.alert("\u5f88\u62b1\u6b49\uff0c\u6b64\u5e94\u7528\u6682\u4e0d\u652f\u6301\u5ba2\u6237\u7aef\u3002", null, {
                ...
                [c.id,
                qqweb.portal.getUrlOption(c.id) || {}]
    ...
    this.AppToolBar = new f.Class({
        ...
        adjustButtons: function () {
            ...
            if (c < this._snsButtonNum * 78 + this._navButtonNum * 60) {
                ...
                c < (this._snsButtonNum + this._navButtonNum) * 35 ? (d.hide(this.backwardBtn.parentNode), d.hide(this.forwardBtn.parentNode),
                d.hide(this.refreshBtn.parentNode), d.hide(a[2]), d.hide(a[3]), this._sharePanel && d.setStyle(this._sharePanel.container, "right", "40px")) : (this._buttonParams.hasBackwardButton && d.show(this.backwardBtn.parentNode), this._buttonParams.hasForwardButton && d.show(this.forwardBtn.parentNode), this._buttonParams.hasRefreshButton && d.show(this.refreshBtn.parentNode), d.show(a[2]), d.show(a[3]), this._sharePanel && d.setStyle(this._sharePanel.container, "right", "100px"), c < 255 && (this._commentPanel && this._commentPanel.isShow() && (this.panelManager.hidePanel("comment"), this.window.setNotCurrent(), d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover")), this._complainPanel && this._complainPanel.isShow() && (this.panelManager.hidePanel("complain"), this.window.setNotCurrent(), d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover")), this._sharebox && (this._sharePanel.isShow() || d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover"), this.panelManager.hidePanel("share2weibo"), this.window.setNotCurrent()),
                this._shareQzone && (this._sharePanel.isShow() || d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover"), this.panelManager.hidePanel("share2qzone"), this.window.setNotCurrent()), this._shareXiaoyou && (this._sharePanel.isShow() || d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover"), this.panelManager.hidePanel("sharexiaoyou"), this.window.setNotCurrent())))
            } else {
                this._buttonMinize = !1;
                ...
                var c = this._sharePanel = new f.ui.Panel({
                    ...
                    p = {
                        onWeiboItemClick: function (c) {
                            ...
                            g.addObserver(a._sharebox, "clickCloseButton",
                            p.onShare2WeiboClose);
        ...
        toggleComplainPanel: function () {
            if (this._complainbox) this._complainPanel.isShow() ? this.panelManager.hidePanel("complain") : (this.adjustButtons(),
...
Jx().$package("alloy.notifier", function (f) {
    ...
    var m = new f.Class({
        ...
        o = new f.Class({
            init: function () {
                var a = this._uinCache = {}, b = function (b, c) {
                    var d = a[c];
                ...
                alloy.notifier.register("webTopNotification",
                this.observer.onMessageReceive, this.observer.onMessageHandled, this)
            },
...
Jx().$package("alloy.sound", function (f) {
    ...
    alloy.sound = {
        ...
        playSound: f.platform.iPad ? function (b, c) {
...
Jx().$package("alloy.apiManager", function (f) {
    ...
    var h = {
        ...
        layout: {
            ...
            setWallpaper: {
                ...
                api: function (a) {
                    alloy.layout.confirm("\u7ee7\u7eed\u64cd\u4f5c\u5c06\u4fee\u6539\u60a8\u7684\u684c\u9762\u4e3b\u9898\u8bbe\u7f6e\uff0c\u662f\u5426\u7ee7\u7eed\uff1f", function () {
                        return alloy.layout.themeManager.setWallpaper(a.url,
                        a.mode)
                    })
                }
            },
    ...
    v = function () {
            ...
            try {
                if (k == "app") if (p = alloy.system.getApp(l), g.addObserver(p, j, h), c[l][b.seq] = [p, j, h], j == "pushParam") {
                    ...
                    var p = alloy.system.getApp(l),
                        u = p.getWindowList()[0];
                    u && (j == "message" ? (g.addObserver(p,
                    j, h), c[l][b.seq] = [p, j, h]) : (g.addObserver(u, j, h), c[l][b.seq] = [u, j, h]))
        ...
        b.app_openid = d.openId, b.app_openkey = d.openKey;
    ...
    this.postMessage = function (b, c) {
        ...
        if (!f.isUndefined(b) && !f.isUndefined(b.wid) && !f.isUndefined(b.host) && !f.isUndefined(c)) {
            ...
            if (h && k.test(e)) if (f.isUndefined(window.postMessage)) if (j) e = eval(e), a.PostMessageEx(h, e);
                ...
                if (e = eval(e)) g = g.indexOf("http://") != -1 ? g : "http://" + g, e.postMessage(h,
                g);
...
Jx().$package(alloy.app.msgBubble = new alloy.businessClass.App(alloy.portal.getSystemConfig("msgBubble")), function (f) {
    ...
    var u = {
        ...
        var a = alloy.config.configList.msgBubblePos,
            ...
            g = e.getWidth(l),
            h = e.getHeight(l);
        !f.isUndefined(a) && a.length == 2 ? (b = a[1], a = a[0], b > d - h - 30 && (b = d - h - 30), a > c - g && (a = c - g)) : (b = d - h - 35,
        a = c / 2 - g / 2);
    ...
    d.addObserver(this, "runFirst", function () {
        ...
        f.platform.iPad ? (d.on(r, "touchstart", u.stopPropagation), d.on(document, "touchstart",
        u.onMouseOutBubble), d.on(l, "touchstart", u.onTouchStartBubble)) : (d.on(r, "mousedown", u.stopPropagation), d.on(o, "mouseup", u.onBubblePanelMouseUp), d.on(l, "mouseenter", u.onMouseOverBubble), d.on(l, "mouseleave", u.onMouseOutBubble), d.on(v, "click", u.onBubbleNotifyMessageClick));
...
Jx().$package(alloy.app.messageManager = new alloy.businessClass.App(alloy.portal.getSystemConfig("messageManager")), function (f) {
    var e = f.dom,
        ...
        m, n, l = {
            ...
            e.hide(f.noMsgTip);
            e.show(h);
            for (var k in n) f = n[k], d = f.msgUl.children.length, f.count.innerHTML = "" + d, f.count2.innerHTML = "" + d
        }, p = function (a) {
    ...
    this.init = function () {
        if (!g) {
            ...
            case "flash":
                ...
                document.body.appendChild(c), d = f.browser.ie ? e.id("sharedObject") || window.sharedObject : document.sharedObject;
                this.initStorage = function (a) {
                    d.init(a)
                };
...
Jx().$package("alloy.qplus", function (f) {
        ...
        j = {}, k, h, m = {
            ...
            onQplusMessageHandled: function (b) {
                if (c) {
                    ...
                    if (!(a & b)) return !1;
                    a &= ~b;
                    alloy.localStorage.save("updateFlag",
                    String(a));
    ...
    this.onMessage = function (b) {
        for (var c = b.app_msg, b = b.wqqappid,
        f = 0, g = c.length; f < g; f++) r(c[f], b);
